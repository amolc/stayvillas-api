from django.shortcuts import render, get_object_or_404  # Import for get_object_or_404
...
class EventViews(APIView):
    ...
    def patch(self, request, id=None, org_id=None):
        # Corrected class name from 'Enquiry' to 'Event'
        event = get_object_or_404(Event, id=id)
    ...
    def delete(self, request, id=None, org_id=None):
        # Corrected variable name from 'events' to 'event' for singular form
        event = get_object_or_404(Event, id=id)
        event.delete()
