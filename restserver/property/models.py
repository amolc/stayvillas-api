...
class Property(models.Model):
    ...
    # Bedroom image URLs
    bedroom1_image = models.URLField(max_length=255, null=True, blank=True)
    description1 = models.TextField(default='No description available')
    bedroom2_image = models.URLField(max_length=255,null=True, blank=True)
    description2 = models.TextField(default='No description available')
    bedroom3_image = models.URLField(max_length=255,null=True, blank=True)
    description3 = models.TextField(default='No description available')
    bedroom4_image = models.URLField(max_length=255,null=True, blank=True)
